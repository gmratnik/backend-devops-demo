...
```sh
createdb -U postgres backend-devops-interview # Run if the DB hasn't been created yet.
mise run setup # Installs modules, runs migration and also seeds the database.
mise run start # Run this if you just want to start the app.
```
